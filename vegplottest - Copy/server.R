...
shinyServer(function(input, output,session) {
  ...
  output$map <- renderLeaflet({
    ...
    colfuncMatched <- colorRampPalette(c( "Aquamarine", 
                                         "Blue", "BlueViolet", "CadetBlue",  "Coral", "CornflowerBlue","#7FFF00",
                                         ...
                                         "DarkSlateBlue",   "DarkTurquoise", "DarkViolet", "DeepPink", "DeepSkyBlue",
                                          "DodgerBlue",  "Gold","#8f3e5c","#FF69B4",
                                         "GoldenRod",  "HotPink", "IndianRed","#4B0082", "#00FA9A",
                                         "Lavender", "LavenderBlush",  "LightBlue", "LightCoral","#00FF7F"))
    
    
    
    
    colfuncUnmatched <- colorRampPalette(c( "LightPink", "LightSalmon", "LightSkyBlue","LightSteelBlue",  "LimeGreen", "Magenta", 
                                           ...
                                           "Orange", "OrangeRed", "Orchid", "PaleGoldenRod", "PaleTurquoise", "PaleVioletRed", 
                                            "Pink", "Plum", "PowderBlue", "Purple", "RoyalBlue", "Salmon","#3499ba",
                                             "SkyBlue", "SlateBlue","SteelBlue",  "#8e578e", "Tomato", "Turquoise", "Violet", "Yellow", "YellowGreen"))
