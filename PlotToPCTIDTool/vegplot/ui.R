                                                ...
                                                <div class='rowI'>
                                                   ...
                                                   <div class='colI'style='padding:5px;'>
                                                        <p style='text-align:justify;padding:1px 1px 1px 2px;'>
                                                            <span style='color:#567621;'>This tool helps identify NSW Plant Community Types (PCTs)</span> using the standard floristic survey methods required under the <a href='https://www.environment.nsw.gov.au/topics/animals-and-plants/biodiversity/biodiversity-assessment-method' rel='external' target='_blank' class='external'>NSW Biodiversity Assessment Method (BAM)</a> and promoted by the <a href='https://www.environment.nsw.gov.au/resources/nativeveg/10060nvinttypestand.pdf' rel='external' target='_blank' class='external'>NSW Vegetation Survey Standards.</a> 
                                                            </p>
                                                            ...
                                                            <p style='text-align:justify;padding:1px 10px 1px 2px;'>
                                                            <span style='color:#567621;'>This tool is part of BioNet, the NSW biodiversity data repository.</span> Data on all NSW PCTs is accessible in the <a href='https://www.environment.nsw.gov.au/NSWVCA20PRapp/LoginPR.aspx' rel='external' target='_blank' class='external'>BioNet Vegetation Classification</a> public application. Standard floristic survey site data is accessed in the Flora surveys module of the <a href='https://www.environment.nsw.gov.au/atlaspublicapp/UI_Modules/YETI_/FloraSearch.aspx' rel='external' target='_blank' class='external'>BioNet Atlas</a> application. 
                                                            </p>
                                                            <p style='text-align:justify;padding:1px 10px 1px 2px;'>
                                                            <span style='color:#567621;'>A Plot to PCT Assignment Tool <a href='https://www.environment.nsw.gov.au/research-and-publications/publications-search/plot-to-pct-assignment-tool-user-guide-eastern-nsw-pct-classification' rel='external' target='_blank' class='externalgreen'>User Guide</a> is available.</span> Details of the classification project underpinning the quantitative PCTs in eastern NSW can be found in the <a href='https://www.environment.nsw.gov.au/research-and-publications/publications-search/a-revised-classification-of-plant-communities-of-eastern-new-south-wales' rel='external' target='_blank' class='external'>Revised Classification of Plant Communities of Eastern NSW</a> paper. 
                                                            </p>
                                                            <p style='text-align:justify;padding:1px 10px 1px 2px;'>
                                                            The Plot to PCT Assignment Tool was developed by the Department of Planning and Environment (DPE) and the University of New South Wales (UNSW) with funding from the Australian Research Council (ARC) grant number LP150100972.
                                                            </p>
                                                            
                                                            <div  style='font-weight: bolder;margin:10px 10px 0px 0px;text-align:left;'>
                                                            App last updated:", textOutput("AppLastUpdated", inline=T) ," &nbsp; PCT data is Eastern NSW PCT Classification version 1.1 <br/>
                                                            <a href='#' data-toggle='popover' style='color:#567621;text-decoration:underline;' title='Disclaimer' 
                                                            data-placement='bottom' data-content='The Department of Planning and Environment (DPE) has compiled this publication in good faith, 
                                                                ...
                                                                DPE shall not be liable for any damage which may occur to any person or organisation taking action or not on the basis of this publication. Users should seek appropriate advice when applying the information to their specific needs. 
                                                    ...
                                                    <div class='colI' style='width:60%;padding:5px;'>
                                                        <div style='background-color:#ccd6bc;padding:5px;'>
                                                                  ...
                                                                  <hr/> 
                                                                	...
                                                                	<p style='text-align:justify;padding:5px 10px 5px 10px;'>The <a href='https://www.environment.nsw.gov.au/topics/animals-and-plants/biodiversity/biodiversity-assessment-method' rel='external' target='_blank' class='externalg'>NSW Biodiversity Assessment Method (BAM)</a> is used to assess impacts on biodiversity under the Biodiversity Conservation Act 2016. It requires assessors to collect data using a standard method. A subset of this data is suitable for use in the Plot to PCT Assignment Tool.</p>
                                                                <hr/> 
                                                                	 <h4 style='padding:2px 0px 2px 10px'>NSW Survey Dashboard</h4>
                                                                	<p style='text-align:justify;padding:5px 10px 5px 10px;'>The <a href='https://www.environment.nsw.gov.au/vegetation/understanding-vegetation-classification-data.htm' rel='external' target='_blank' class='externalg'>NSW native vegetation survey dashboard</a> provides an overview of floristic survey effort in different regions of NSW. Poorly surveyed areas may have incomplete native vegetation classification inventories. Users are encouraged to check their area of interest on the survey dashboard.</p>
                                     ...
                                     HTML("<table style='border:none;'>
                                           ...
                                           HTML( paste0("
                                                ...
                                                To use this tool please upload standard floristic survey site data using the browse button to the left.
                                                 ...
                                                 The Flora surveys module of the BioNet Atlas application has been set up to store and export data ready for direct upload to this tool. If you haven’t yet done so, first enter your standard floristic survey data into the Flora surveys module of the BioNet Atlas application and then export it. Instructional videos on entering and exporting flora survey data to and from BioNet are <a href='https://vimeo.com/showcase/6521210' rel='external' target='_blank' class='external'>available.</a>
                                                 </p><p style='text-align:justify;padding:1px 15px 1px 2px;'>
                                                Data uploaded to this tool is assumed to have been exported from the Flora surveys module of the BioNet Atlas application using the 'PCT classification taxonomic assignment' and the 'Plot to PCT assignment tool' output format, which automatically applies the required taxonomic treatment, the cover and abundance score conversions, and the truncated scientific name known as a PATN label (usually the first four letters of the genus and the first four letters of the species). Uploading data that hasn't had the taxonomic treatments and cover score conversions applied may give unreliable results.
                                                 </p><p style='text-align:justify;padding:1px 15px 1px 2px;'>
                                           ...
                                           HTML("</td>
                                                <td style='vertical-align:top;background-color:#ccd6bc;'>
                                                    ...
                                                    <p style='padding:5px 5px 5px 10px;'>This tool relies on the use of a specific taxonomic treatment for flora species names. This treatment was applied to the BioNet flora species names list during the eastern NSW PCT classification to provide consistent epithets across 50,000 sites in eastern NSW. The treatment is known as the 'PCT classification taxonomic assignment'. It is important that site species data is standardised to this specific treatment for use in this tool. The Flora surveys module of the BioNet Atlas application has this taxonomic treatment functionality built in and available for your use. The BioNet flora species names are available in the Flora sheet within the <a href='https://www.environment.nsw.gov.au/topics/animals-and-plants/biodiversity/nsw-bionet/resources/bionet-atlas-flora-survey-upload-datasheet' rel='external' target='_blank' class='externalg'>BioNet Atlas Flora Survey upload spreadsheet.</a></p>
                                                    <hr/> 
                                                    ...
                                                    <p style='text-align:justify;padding:5px 10px 5px 10px;'>This tool is underpinned by standard floristic survey sites collected by a large number of botanists for different purposes over decades and stored within BioNet. Different surveys have used different methods to estimate cover and abundance of plant species within sites. In order to compare sites, cover and abundance data is transformed to a standard schema. The schema used is a 1 to 6 cover abundance score where: 
                                                               ...
                                                               <br/> It is important that cover and abundance data for new sites is standardised to this schema. The Flora surveys module of the BioNet Atlas application has this functionality built in and available for your use</p>
                                  ...
                                  fluidRow(
                                    tabsetPanel(
                                      ...
                                      tabPanel("Map View", value=3,
                                               fluidPage(
                                                 HTML("<br/>Displayed are: publicly available sites drawn from the Flora surveys module of the BioNet Atlas application that are classified to a quantitative PCT, sites uploaded to this Plot to PCT Assignment Tool during the current session.<br/>
                                                 Additional sites held by BioNet but not visible here include: recently collected sites, sites that are not publicly available, sites not classified to a quantitative PCT, data collected using methods inconsistent with those used in the development of PCTs.<br/>
